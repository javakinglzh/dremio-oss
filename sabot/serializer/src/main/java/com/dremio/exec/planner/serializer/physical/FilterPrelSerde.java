...
public class FilterPrelSerde {

  public static PPhyscialRels.PFilterPrel toProto(FilterPrel pojo, PrelToProto prelToProto) {
    return PPhyscialRels.PFilterPrel.newBuilder()
  ...
  public static FilterPrel fromProto(PPhyscialRels.PFilterPrel proto, ProtoToPrel protoToPrel) {
