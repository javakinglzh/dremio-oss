...
/*
 Interface for store providers for Distributed plan cache.
*/
public interface DistributedPlanCacheStoreProvider extends Service {
  <T extends TransientStore<ByteArrayKey, byte[]>> T provideStore(
