...
public class NatsStreamManagementIT {
  ...
  @Test
  public void test_createStreamDoesNotImpactProcessing() throws InterruptedException {
    // given
    NatsPubSubClient client = new NatsPubSubClient(natsTestStarter.getNatsUrl());
    ...
    MessageSubscriber<StringValue> subscriber =
        client.getSubscriber(
            ...
            messageConsumer,
            new ImmutableMessageSubscriberOptions.Builder<StringValue>()
                .setStreamName(STREAM_NAME)
                .build());
