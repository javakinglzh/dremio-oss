...
const Reflection = (props) => {
  ...
  const isReflectionsShown =
    reflectionsUsed.size > 0 ||
    reflectionsNotUsed.size > 0 ||
    isAcceleratedByCache;
  return (
    <div>
      {isReflectionsShown && (
...
Reflection.propTypes = {
  ...
  isAcceleratedByCache: PropTypes.bool,
